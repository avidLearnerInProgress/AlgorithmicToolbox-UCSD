...
ll get_fibonacci_square_sum_fast(ll n){
    
    ll current = get_fibonacci_fast(n % 60);
    ll next = get_fibonacci_fast((n + 1) % 60);
...
int main() {
    ll n;
    cin>> n;
    cout << get_fibonacci_square_sum_fast(n) << '\n';
}
